...
export default function Home() {
  ...
  return (
    <div class="home">
      ...
      <button onClick={() => { modal.current.classList.toggle('yes') }} className="cta">Get Started</button>
      <div className="modal-container" ref={modal}>
        <div className="modal">
          <button className="btn close" onClick={() => { modal.current.classList.toggle('yes') }}><img className="closeimg" src={cancel} alt="" /></button>
          ...
          <div className="authmethod google">
            <a href="http://localhost:3500/auth/google">
              <button className="authmethod-btn google">
                <img src={google} className="authicon" alt="" />
                {" "}
          ...
          <div className="authmethod github">
            <a href="http://localhost:3500/auth/github">
              <button className="authmethod-btn github">
                <img src={github} className="authicon" alt="" />
                {" "}
